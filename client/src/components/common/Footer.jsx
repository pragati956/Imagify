  ...
  return (
    <footer className="border-t border-gray-200 dark:border-gray-800 mt-4 transition-colors">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-6 flex flex-col sm:flex-row items-center justify-center sm:justify-between gap-5">
        ...
        >
          {/* Logo now blends into the theme instead of sitting in a boxed pill */}
          <img
            src={assets.logo}
            alt="Imagify Logo"
            className="w-32 sm:w-36 hover:scale-105 transition-transform duration-300 cursor-pointer dark:brightness-0 dark:invert"
          />
        </Link>
