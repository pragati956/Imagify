...
const Description = () => {
  return (
    ...
    >
      <span className="text-blue-600 dark:text-blue-400 font-semibold uppercase tracking-widest text-sm mb-2 transition-colors">
        Why Choose Imagify?
      </span>
      ...
      <p className="text-gray-500 dark:text-gray-400 mb-16 text-center max-w-2xl transition-colors">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center gap-10 lg:gap-16 w-full">
        ...
        <div className="flex gap-4 w-full max-w-md relative">
            <img
                ...
                className="w-1/2 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 z-10 hover:scale-105 transition-all duration-300 object-cover" 
                loading="lazy"        
            />
             <img
                src={assets.sample_img_2}
                alt="AI generated artwork example 2"
                className="w-1/2 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 mt-8 hover:scale-105 transition-all duration-300 object-cover" 
                loading="lazy"        
            />
        </div>
        ...
        <div className="max-w-xl flex flex-col gap-8">
          ...
          <div className="flex gap-4">
              <div className="bg-blue-100 dark:bg-blue-900/40 p-3 rounded-xl h-fit transition-colors">
                  <Tags className="text-blue-600 dark:text-blue-400" size={24} />
              </div>
              <div>
                  <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2 transition-colors">One-Click Style Tags</h3>
          ...
          <div className="flex gap-4">
              <div className="bg-purple-100 dark:bg-purple-900/40 p-3 rounded-xl h-fit transition-colors">
                  <Sparkles className="text-purple-600 dark:text-purple-400" size={24} />
              </div>
              <div>
                  <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2 transition-colors">Gemini AI Assistant</h3>
                  <p className="text-gray-600 dark:text-gray-400 leading-relaxed transition-colors">
          ...
          <div className="flex gap-4">
              <div className="bg-green-100 dark:bg-green-900/40 p-3 rounded-xl h-fit transition-colors">
                  <Wand2 className="text-green-600 dark:text-green-400" size={24} />
              </div>
              <div>
                  <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2 transition-colors">Flawless Rendering</h3>
                  <p className="text-gray-600 dark:text-gray-400 leading-relaxed transition-colors">
